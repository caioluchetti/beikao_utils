...
@Mod(value = BeikaoUtils.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = BeikaoUtils.MODID, value = Dist.CLIENT)
public class BeikaoUtilsClient {
    public BeikaoUtilsClient(ModContainer container) {
